...
var building_models := {
        ...
        "wall_brick_2x2": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Brick_2x2.gltf", "type": "building", "category": "wall"},
        "wall_brick_2x4": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Brick_2x4.gltf", "type": "building", "category": "wall"},
        "wall_plaster_2x2": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Plaster_2x2.gltf", "type": "building", "category": "wall"},
        "wall_plaster_2x4": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Plaster_2x4.gltf", "type": "building", "category": "wall"},
        "wall_timber_2x2": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Timber_2x2.gltf", "type": "building", "category": "wall"},
        "wall_timber_2x4": {"path": MEDIEVAL_VILLAGE_PATH + "Wall_Timber_2x4.gltf", "type": "building", "category": "wall"},
        "roof_roundtiles_4x4": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_RoundTiles_4x4.gltf", "type": "building", "category": "roof"},
        "roof_roundtiles_4x6": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_RoundTiles_4x6.gltf", "type": "building", "category": "roof"},
        "roof_roundtiles_6x6": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_RoundTiles_6x6.gltf", "type": "building", "category": "roof"},
        "roof_roundtiles_6x8": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_RoundTiles_6x8.gltf", "type": "building", "category": "roof"},
        "roof_front_brick4": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_Front_Brick4.gltf", "type": "building", "category": "roof"},
        "roof_front_brick6": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_Front_Brick6.gltf", "type": "building", "category": "roof"},
        "roof_dormer": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_Dormer_RoundTile.gltf", "type": "building", "category": "roof"},
        "roof_log": {"path": MEDIEVAL_VILLAGE_PATH + "Roof_Log.gltf", "type": "building", "category": "roof"},
        "stairs_straight": {"path": MEDIEVAL_VILLAGE_PATH + "Stairs_Straight.gltf", "type": "building", "category": "stairs"},
        "stairs_straight_open": {"path": MEDIEVAL_VILLAGE_PATH + "Stairs_Straight_Open.gltf", "type": "building", "category": "stairs"},
        "stairs_modular": {"path": MEDIEVAL_VILLAGE_PATH + "Stairs_Modular.gltf", "type": "building", "category": "stairs"},
        "stairs_modular_railing": {"path": MEDIEVAL_VILLAGE_PATH + "Stairs_Modular_Railing.gltf", "type": "building", "category": "stairs"},
        "window_1_plaster": {"path": MEDIEVAL_VILLAGE_PATH + "Window_1_Plaster.gltf", "type": "building", "category": "window"},
        "window_1_brick": {"path": MEDIEVAL_VILLAGE_PATH + "Window_1_Brick.gltf", "type": "building", "category": "window"},
        "window_2_plaster": {"path": MEDIEVAL_VILLAGE_PATH + "Window_2_Plaster.gltf", "type": "building", "category": "window"},
        "window_2_brick": {"path": MEDIEVAL_VILLAGE_PATH + "Window_2_Brick.gltf", "type": "building", "category": "window"},
        "window_4_plaster": {"path": MEDIEVAL_VILLAGE_PATH + "Window_4_Plaster.gltf", "type": "building", "category": "window"},
        "window_shutters": {"path": MEDIEVAL_VILLAGE_PATH + "WindowProp_Shutters.gltf", "type": "building", "category": "window"},
        "fence_wooden": {"path": MEDIEVAL_VILLAGE_PATH + "Prop_WoodenFence.gltf", "type": "building", "category": "fence"},
        "fence_metal": {"path": MEDIEVAL_VILLAGE_PATH + "Prop_MetalFence_Simple.gltf", "type": "building", "category": "fence"},
        "well": {"path": MEDIEVAL_VILLAGE_PATH + "Prop_Well.gltf", "type": "building", "category": "prop"},
        "lamppost": {"path": MEDIEVAL_VILLAGE_PATH + "Prop_Lamppost.gltf", "type": "building", "category": "light"},
        "sign_board": {"path": MEDIEVAL_VILLAGE_PATH + "Prop_SignBoard.gltf", "type": "building", "category": "prop"}
}
