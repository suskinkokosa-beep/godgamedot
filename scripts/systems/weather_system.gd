...
func _process(delta):
        ...
        if target_weather != current_weather:
                ...
                if weather_transition >= 1.0:
                        ...
                        emit_signal("weather_changed", get_weather_string(current_weather))
...
func get_weather_string(weather: int) -> String:
        var weather_strings := {
                WeatherType.CLEAR: "clear",
                WeatherType.CLOUDY: "cloudy",
                WeatherType.RAIN: "rain",
                WeatherType.HEAVY_RAIN: "rain",
                WeatherType.SNOW: "snow",
                WeatherType.BLIZZARD: "blizzard",
                WeatherType.STORM: "storm",
                WeatherType.FOG: "fog"
        }
        return weather_strings.get(weather, "clear")
