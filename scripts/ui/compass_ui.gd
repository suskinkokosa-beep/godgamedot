...
var compass_bar: ColorRect = null
var direction_label: Label = null
var markers_container: Control = null
...
func _setup_ui():
        ...
        compass_bar = get_node_or_null("CompassBar")
        direction_label = get_node_or_null("DirectionLabel")
        markers_container = get_node_or_null("MarkersContainer")
